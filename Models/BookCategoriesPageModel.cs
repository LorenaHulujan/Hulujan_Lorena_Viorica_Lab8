...
namespace Hulujan_Lorena_Viorica_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Hulujan_Lorena_Viorica_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Hulujan_Lorena_Viorica_Lab8Context context,
